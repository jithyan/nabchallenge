...
export interface BestProfitDisplayProps {
  date: string;
  currencyName: string;
  buyTime: string;
  sellTime: string;
...
const BestProfitDispay: React.FC<BestProfitDisplayProps> = React.memo(
  ({ currencyName, date, buyTime, sellTime, buyPrice, sellPrice, profit }) => {
    return (
